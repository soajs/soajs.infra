...
if (backend.requestOptions && backend.requestOptions.baseUrl && backend.requestOptions.ca && backend.authProvider) {
	...
	console.log("\n");
	// if (!backend.requestOptions.auth || !backend.requestOptions.auth.bearer) {
	// 	console.log("Auth bearer token is missing you will need to run : kubectl describe secrets");
	// 	console.log("\n");
	// }
} else {
